...
def setup_option(args)
  ...
  opt_parser = OptionParser.new do |opts|
    ...
    opts.separator "Everything ends in a"
    opts.separator ""
    # enumeration
...
def add_empty_lines(current_name)
  ...
  puts "seq.#{current_name}a\t141\t*\t0\t255\t*\t*\t0\t0\tNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN\t."
end
...
def fix_lines(lines,current_name)
  ...
  rev_reads.each_with_index do |rev, i|
    ...
    fwd = add_HI_tag(fwd,i+1)
    rev = add_HI_tag(rev,i+1)
    fwd[0] = fwd[0].sub(/b$/,"a")
    rev[0] = rev[0].sub(/b$/,"a")
    puts fwd.join("\t")
    puts rev.join("\t")
